...
export default function BookPageClient() {
  ...
  return (
    <>
      {/* Minimal Hero - just title */}
      <section className="bg-gradient-to-br from-orange-600 via-red-600 to-pink-600 py-8 sm:py-10">
        <Container>
          <div className="text-center">
            <h1 className="text-3xl sm:text-4xl font-bold text-white">
              Book Your Free Diagnostic
            </h1>
            <p className="text-white/80 mt-2">Join 500+ students who've improved their NAPLAN scores</p>
          </div>
        </Container>
      </section>

      {/* === BOOKING FORM - Right below header === */}
        ...
        <Container>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="bg-gradient-to-br from-orange-50 to-red-50 rounded-2xl p-6 shadow-lg">
              <div className="flex gap-1 text-orange-500 mb-3">⭐⭐⭐⭐⭐</div>
              <p className="text-gray-600 italic mb-4">
                "Best decision we made! My son's confidence in maths skyrocketed. The tutors are patient and really know how to explain concepts in a way kids understand."
              </p>
              <p className="font-semibold text-gray-900">— James T., Sydney</p>
            </div>
            ...
            <div className="bg-gradient-to-br from-orange-50 to-red-50 rounded-2xl p-6 shadow-lg">
              <div className="flex gap-1 text-orange-500 mb-3">⭐⭐⭐⭐⭐</div>
              <p className="text-gray-600 italic mb-4">
                "From Year 5 to Year 7, our daughter went from average to top of her class. The personalized approach made all the difference. Highly recommend!"
              </p>
              <p className="font-semibold text-gray-900">— Priya K., Melbourne</p>
            </div>
          </div>
        </Container>
      </section>

      {/* === BANNER - Below Testimonials === */}
      <section className="py-12 sm:py-16 bg-gradient-to-r from-orange-600 via-red-600 to-pink-600">
        <Container>
          <div className="text-center">
            <h2 className="text-2xl sm:text-3xl font-bold text-white mb-4">
              🎯 Ready to Boost Your Child's NAPLAN Score?
            </h2>
            <p className="text-white/90 text-lg mb-8 max-w-2xl mx-auto">
              Join 500+ students who have improved their scores with our personalized tutoring approach.
            </p>
      ...
      {/* Stats Bar */}
      <div className="bg-white shadow-xl mx-4 -mb-6 relative z-10 rounded-2xl max-w-4xl mx-auto">
